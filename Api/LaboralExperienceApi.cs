...
namespace Employex.Api
{
    ...
    /// </summary>
        public interface ILaboralExperienceApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task AddLaboralExperienceAsync (LaboralExperience body, int? userId);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> AddLaboralExperienceAsyncWithHttpInfo (LaboralExperience body, int? userId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class LaboralExperienceApi : ILaboralExperienceApi
    {
        private Employex.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LaboralExperienceApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LaboralExperienceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public LaboralExperienceApi(Employex.Client.Configuration configuration = null)
        {
